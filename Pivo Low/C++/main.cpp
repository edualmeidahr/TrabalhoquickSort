...
void quickSort(std::vector<int>& vetor, int esquerda, int direita) {
    ...
    int pivo = vetor[esquerda];  // Escolhendo o pivô como o primeiro elemento
...
int main() {
    ...
    switch (ordem) {
        case 1:
            pasta_resultados_base = "QuickSort/Pivo Low/Resultados/C++/";
            pasta_resultados_tipo = "QuickSort/Pivo Low/Resultados/Desordenado/";
            break;
        case 2:
            pasta_resultados_base = "QuickSort/Pivo Low/Resultados/C++/";
            pasta_resultados_tipo = "QuickSort/Pivo Low/Resultados/Crescente/";
            break;
        case 3:
            pasta_resultados_base = "QuickSort/Pivo Low/Resultados/C++/";
            pasta_resultados_tipo = "QuickSort/Pivo Low/Resultados/Decrescente/";
            break;
        default:
    ...
    switch (ordem) {
        case 1:
            arquivo_resultados_base = pasta_resultados_base + "LOWdesordenadoC++.txt";
            arquivo_resultados_tipo = pasta_resultados_tipo + "LOWdesordenadoC++.txt";
            break;
        case 2:
            arquivo_resultados_base = pasta_resultados_base + "LOWcrescenteC++.txt";
            arquivo_resultados_tipo = pasta_resultados_tipo + "LOWcrescenteC++.txt";
            break;
        case 3:
            arquivo_resultados_base = pasta_resultados_base + "LOWdecrescenteC++.txt";
            arquivo_resultados_tipo = pasta_resultados_tipo + "LOWdecrescenteC++.txt";
            break;
    }
