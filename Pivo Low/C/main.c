...
void quickSort(int* vetor, int esquerda, int direita) {
    ...
    int pivo = vetor[esquerda];  // Escolhendo o pivô como o elemento mais à esquerda
...
int main() {
    ...
    switch (ordem) {
        case 1:
            strcpy(pasta_resultados, "QuickSort/Pivo Low/Resultados/Desordenado/");
            break;
        case 2:
            strcpy(pasta_resultados, "QuickSort/Pivo Low/Resultados/Crescente/");
            break;
        case 3:
            strcpy(pasta_resultados, "QuickSort/Pivo Low/Resultados/Decrescente/");
            break;
        default:
    ...
    sprintf(arquivo_resultados_c, "QuickSort/Pivo Low/Resultados/C/LOW%sC.txt", ordem == 1 ? "Desordenado" : (ordem == 2 ? "Crescente" : "Decrescente"));
