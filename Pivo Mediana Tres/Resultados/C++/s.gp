...
plot "desordenadoC++.txt" using 1:2 with lines title 'Desordenado', \
     "crescenteC++.txt" using 1:2 with lines title 'Crescente', \
     "decrescenteC++.txt" using 1:2 with lines title 'Decrescente'	
