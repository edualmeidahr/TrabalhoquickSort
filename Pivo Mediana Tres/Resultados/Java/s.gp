...
plot "desordenadoJava.txt" using 1:2 with lines title 'Desordenado', \
     "crescenteJava.txt" using 1:2 with lines title 'Crescente', \
     "decrescenteJava.txt" using 1:2 with lines title 'Decrescente'	
