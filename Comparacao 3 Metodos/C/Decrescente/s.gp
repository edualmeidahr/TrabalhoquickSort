...
set title "C - Escolha Diferentes de Pivo - Decrescente"
...
plot "decrescenteC.txt" using 1:2 with lines title 'Mediana de 3', \
     "MAXdecrescenteC.txt" using 1:2 with lines title 'Ultimo Elemento', \
     "LOWDecrescenteC.txt" using 1:2 with lines title 'Primeiro Elemento'	
